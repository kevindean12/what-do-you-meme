...
import {InitGoogle, InitFacebook} from '../models/oAuthHelpers';
/* globals FB*/
export default function LoginComponent(){
    
    //do this for any changeable data in React
    //these are hooks
    ...
    function google_login(e){
        setError('You logged you in with Google');
        e.preventDefault();
        window.auth2.signIn()
            .then(googleUser =>{
